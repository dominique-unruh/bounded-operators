...
locale bounded_cbilinear =
  fixes prod :: "'a::complex_normed_vector \<Rightarrow> 'b::complex_normed_vector \<Rightarrow> 'c::complex_normed_vector"
    (* (infixl "**" 70) *) (* Notation clashes with bounded_bilinear.prod *)
...
lemma cbounded_linear_of_real: "cbounded_linear (\<lambda>r. of_real r)"
  unfolding of_complex_def by (rule cbounded_linear_scaleC_left)

lemma complex_cbounded_linear: "cbounded_linear f \<longleftrightarrow> (\<exists>c::real. f = (\<lambda>x. x * c))"
