...
class complex_normed_vector = complex_vector + sgn_div_norm + dist_norm + uniformity_dist + open_uniformity +
  ...
  assumes norm_scaleC [simp]: "norm (scaleC a x) = \<bar>a\<bar> * norm x"
begin
