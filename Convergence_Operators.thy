...
definition uconvergent :: "(nat \<Rightarrow> ('a::real_normed_vector \<Rightarrow> 'b::real_normed_vector)) \<Rightarrow> bool"
  where "uconvergent f = (\<exists>l. f \<midarrow>ustrong\<rightarrow> l )"
