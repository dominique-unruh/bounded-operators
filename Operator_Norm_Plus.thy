...
Complement to the file HOL/Analysis/Operator_Norm.thy (Amine Chaieb, Brian Huffman).
...
(* NEW *)
(* Notice that this lemma is false if we delete the condition "'a::perfect_space", e.g., the
